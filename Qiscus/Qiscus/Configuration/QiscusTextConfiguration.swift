...
open class QiscusTextConfiguration: NSObject {
    ...
    @objc open var readOnlyText = "Archieved message: This message was locked. Click the key to open the conversation."
    
    /// Your text placeholder if you want to send any message, Default value : "Text a message here ..."
    @objc open var textPlaceholder = "Text Message"
    
    @objc public var captionPlaceholder = "Caption here..."
    /// Your text to show as title alert when you access gallery but you not allow gallery access, Default value : "Important"
    @objc open var galeryAccessAlertTitle = "Important"
    ...
    @objc open var galeryAccessAlertText = "We need photos access to upload image.\nPlease allow photos access in your iPhone Setting"
    @objc open var locationAccessAlertText = "We need location access to share your current location.\nPlease allow location access in your iPhone Setting"
    @objc open var cameraAccessAlertText = "We need camera access to upload image from camera.\nPlease allow camera access in your iPhone Setting"
    @objc open var microphoneAccessAlertText = "We need microphone access to upload recorded audio.\nPlease allow mictophone access in your iPhone Setting"
    
    /// Your text to show as title confirmation when you want to upload image/file, Default value : "CONFIRMATION"
    @objc open var confirmationTitle = "CONFIRMATION".getLocalize()
    
    /// Your text to show as content confirmation when you want to upload image, Default value : "Are you sure to send this image?"
    @objc open var confirmationImageUploadText = "UPLOAD_IMAGE_CONFIRMATION".getLocalize()
    
    /// Your text to show as content confirmation when you want to upload file, Default value : "Are you sure to send"
    @objc open var confirmationFileUploadText = "UPLOAD_FILE_CONFIRMATION".getLocalize()
    
    /// Your text in back action, Default value : ""
    @objc open var backText = ""
    
    /// Your question mark, Default value : "?"
    @objc open var questionMark = "?"
    
    /// Your text in alert OK button, Default value : "OK"
    @objc open var alertOkText = "OK"
    
    /// Your text in alert Cancel button, Default value : "CANCEL"
    @objc open var alertCancelText = "CANCEL".getLocalize()
    
    /// Your text in alert Setting button, Default value : "SETTING"
    @objc open var alertSettingText = "SETTING".getLocalize()
    
    /// Your text if the day is "today", Default value : "Today"
    @objc open var todayText = "Today"
    
    /// Your text if it is the process of uploading file, Default value : "Uploading"
    @objc open var uploadingText = "UPLOADING".getLocalize()
    /// Your text if it is the process of uploading file, Default value : "Uploading"
    @objc open var downloadingText = "DOWNLOADING".getLocalize()
    
    /// Your text if it is the process of uploading image, Default value : "Sending"
    @objc open var sendingText = "SENDING".getLocalize()
    
    /// Your text if the process of uploading fail, Default value : "Sending Failed"
    @objc open var failedText = "FAILED".getLocalize()
    
    @objc open var deletingText = "DELETING".getLocalize()
    
    /// Your text if there isn't connection internet, Default value :  "can't connect to internet, please check your connection"
    @objc open var noConnectionText = "NO_CONNECTION".getLocalize()
    
    @objc open var defaultRoomSubtitle = "not Available"
    
    @objc open var deleteForEveryOne = "DELETE_FOR_ME".getLocalize()
